...
export default function SinglePost(){
    ...
    return (
        <main className="bg-gray-200 min-h-scren p-12">
            ...
            <div className="px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl mac-w-full">
                <BlockContent blocks={singlePost.body} projectId="y8uo67i8" dataset="production"/>
            </div>
            </article>
        </main>
    )
